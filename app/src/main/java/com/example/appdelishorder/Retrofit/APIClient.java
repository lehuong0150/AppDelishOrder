...
public class APIClient {
    private static final String BASE_URL = "http://192.168.1.70:7010/api/";  // Đổi thành URL server thực tế
    ...
    public static Retrofit getClient() {
        if (retrofit == null) {
            ...
            retrofit = new Retrofit.Builder()
                    .baseUrl("http://192.168.1.70:7010/api/") // Đặt URL API của bạn tại đây
